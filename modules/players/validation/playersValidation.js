...
exports.createPlayerSchema = z.object({
  ...
  pac: z.number().int().min(0).max(99).optional(),
  sho: z.number().int().min(0).max(99).optional(),
  pas: z.number().int().min(0).max(99).optional(),
  dri: z.number().int().min(0).max(99).optional(),
  def: z.number().int().min(0).max(99).optional(),
  phy: z.number().int().min(0).max(99).optional(),
